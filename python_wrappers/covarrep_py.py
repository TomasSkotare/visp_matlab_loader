...
class CovarepWrapper:
    ...
    def __init__(self, covarep_directory, verbose=False):
        ...
        self.expected_functions = extract_covarep_expected_functions("http://covarep.github.io/covarep/contributions.html")
    ...
    def execute_function(self, function_name, output_count, inputs):
        executor = ExecuteCompiledProject(self.covarep_project, return_inputs=True, verbose=self.verbose)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description='Python script that takes a path as an input argument.')
