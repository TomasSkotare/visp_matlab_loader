...
class TestMatlabProject:
    ...
    def test_project(self) -> list[tuple[str, MatlabExecutionResult, MatlabExecutionResult]]:
        ...
        for test_case in project.test_case_files:
            ...
            if not matlab_function:
                logger.warning(f'Function {test_case_execution.function_name} not found in the project {project.name}! Skipping...')
                continue
